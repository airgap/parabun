...
// Bump when Parabun parser semantics change (..! ..& ..= |> pure desugaring).
// Invalidates bytecode sidecars generated by older parser versions.
pub const parabun_parser_version: u32 = 1;
pub const parabun_bytecode_header = std.mem.toBytes(@as(u32, parabun_parser_version));
