...
var root_3 = $.from_html(`<p> </p> <p> </p> <p> </p> <p> </p>`, 1);
...
export default function Main($$anchor) {
...

	{
		...
		$.boundary(node, { pending }, ($$anchor) => {
			...
			$.boundary(node_1, {}, ($$anchor) => {
				...
				$.template_effect(
					($0, $1, $2) => {
						...
						$.set_text(text_1, $1);
						$.set_text(text_2, $2);
						$.set_text(text_3, `inner pending: ${$.eager($.pending) ?? ''}`);
					},
					void 0,
					[
						() => push($.get(value)),
			...
			var p_5 = $.sibling(node_1, 2);
			var text_4 = $.child(p_5);

			$.reset(p_5);
			$.template_effect(() => $.set_text(text_4, `outer pending: ${$.eager($.pending) ?? ''}`));
