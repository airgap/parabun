...
declare module '@para/ui/animate' {
...
declare module '@para/ui/attachments' {
	/**
...
declare module '@para/ui/compiler' {
...
declare module '@para/ui/reactivity' {
	/**
...
declare module '@para/ui/reactivity/window' {
	/**
...
declare module '@para/ui/transition' {
...
declare module '@para/ui/types/compiler/preprocess' {
...
declare module '@para/ui/types/compiler/interfaces' {
	import type { Location } from 'locate-character';
