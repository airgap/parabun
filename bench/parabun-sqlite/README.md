...
2. Do Parabun's language features (`pure`, `@lyku/para-simd`, typed-array
...
2. **`@lyku/para-simd.sum` / `@lyku/para-simd.dot`** replace the scalar reduction
...
- `variant-c.pjs` — columnar Float64Array extraction, `@lyku/para-simd.sum`/`dot`,
