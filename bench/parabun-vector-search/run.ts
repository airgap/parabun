...
const variants = [
  ...
  { name: "simd-dot (per-row, bun:simd.dot)", path: `${HERE}variant-simd.pjs` },
  { name: "matvec (bun:simd.matVec, bulk) ", path: `${HERE}variant-matvec.pjs` },
  ...
  { name: "gpu (bun:gpu.matVec, held)     ", path: `${HERE}variant-gpu.pjs` },
];
