...
// matVec, matmul fall back to @lyku/para-simd, matching the CUDA backend's
// Phase-1 shape.
//
...
// from @lyku/para-simd's left-to-right accumulator, so outputs may differ from
...
// backend's lifetime, matching @lyku/para-simd.alloc's commit-for-lifetime model.
...
// f64 still forwards to @lyku/para-simd. f64 handles allocate no buffer and just
