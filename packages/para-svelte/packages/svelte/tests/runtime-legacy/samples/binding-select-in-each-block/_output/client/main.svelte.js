...
var root_1 = $.from_html(`<select><option>Hullo</option><option>World</option></select>`);
...
export default function Main($$anchor, $$props) {
	...
	$.each(node, 1, items, $.index, ($$anchor, item, $$index) => {
		...
		option.value = option.__value = 'hullo';
		...
		$.bind_select_value(select, () => $.get(item).value, ($$value) => (
