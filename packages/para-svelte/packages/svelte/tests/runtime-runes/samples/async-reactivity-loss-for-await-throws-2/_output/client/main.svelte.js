...
var root_1 = $.add_locations($.from_html(`<p>pending</p>`), Main[$.FILENAME], [[41, 2]]);
var root_2 = $.add_locations($.from_html(`<h1> </h1>`), Main[$.FILENAME], [[38, 1]]);
	...
	async function get_result() {
		...
		try {
			for await (const value of $.for_await_track_reactivity_loss(iterator)) {
				...
				$.strict_equals(values.length, value);
			}
