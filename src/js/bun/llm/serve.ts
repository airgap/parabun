// parabun:llm — HTTP serving subsurface (`llm.serve(opts)`).
//
...
/**
 * The engine interface. A parabun:llm instance satisfies this naturally; users
...
type ServeOptions = {
  ...
  apiKey?: string;
  /**
   * Maximum concurrent generations. Most local engines (llama.cpp, parabun:llm)
