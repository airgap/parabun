// Parabun: native image-codec bindings for `parabun:image`.
//
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    if (!format) {
        throwTypeError(globalObject, scope, "parabun:image.decode: unrecognized format (expected JPEG or PNG)"_s);
        return {};
    }
    ...
    if (!ok) {
        throwTypeError(globalObject, scope, makeString("parabun:image.decode: "_s, String::fromUTF8(errMsg)));
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    if (!imgArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.encode: img must be the object returned from decode()"_s);
        return {};
    }
    ...
    if (!optsArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.encode: opts must be { format, quality? }"_s);
        return {};
    }
    ...
    if (!formatVal.isString()) {
        throwTypeError(globalObject, scope, "parabun:image.encode: opts.format must be \"jpeg\" or \"png\""_s);
        return {};
    }
    ...
    if (!isJpeg && !isPng && !isWebp) {
        throwTypeError(globalObject, scope, makeString("parabun:image.encode: unknown format "_s, formatVal.toWTFString(globalObject)));
        return {};
    }
    ...
    if (!widthVal.isNumber() || !heightVal.isNumber() || !channelsVal.isNumber()) {
        throwTypeError(globalObject, scope, "parabun:image.encode: img.width/height/channels must be numbers"_s);
        return {};
    }
    if (!dataVal.isCell() || dataVal.asCell()->type() != JSC::Uint8ArrayType) {
        throwTypeError(globalObject, scope, "parabun:image.encode: img.data must be a Uint8Array"_s);
        return {};
    }
    ...
    if (dataView->length() != static_cast<size_t>(width) * height * channels) {
        throwTypeError(globalObject, scope, "parabun:image.encode: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    if (!ok) {
        throwTypeError(globalObject, scope, makeString("parabun:image.encode: "_s, String::fromUTF8(errMsg)));
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    if (!imgArg.isObject() || !optsArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.resize: expected (img, { width, height })"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    auto* optsObj = asObject(optsArg);
    ...
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.resize: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(sw) * sh * channels) {
        throwTypeError(globalObject, scope, "parabun:image.resize: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    if (!dwVal.isNumber() || !dhVal.isNumber()) {
        throwTypeError(globalObject, scope, "parabun:image.resize: opts.width and opts.height are required"_s);
        return {};
    }
    ...
    if (dwSigned < 1 || dhSigned < 1) {
        throwTypeError(globalObject, scope, "parabun:image.resize: opts.width and opts.height must be >= 1"_s);
        return {};
    }
    ...
    if (kernelVal.isString()) {
        ...
        if (std::strcmp(kStr.data(), "lanczos") == 0) {
            ...
            throwTypeError(globalObject, scope, "parabun:image.resize: opts.kernel must be \"bilinear\" or \"lanczos\""_s);
            return {};
        }
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue optsArg = callFrame->argument(1);
    if (!imgArg.isObject() || !optsArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.blur: expected (img, { radius })"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    auto* optsObj = asObject(optsArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.blur: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.blur: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    if (!radiusVal.isNumber()) {
        throwTypeError(globalObject, scope, "parabun:image.blur: opts.radius is required (number)"_s);
        return {};
    }
    const int radius = radiusVal.toInt32(globalObject);
    if (radius < 0 || radius > 100) {
        throwTypeError(globalObject, scope, "parabun:image.blur: radius must be in [0, 100]"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue optsArg = callFrame->argument(1);
    if (!imgArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.sharpen: expected (img, { amount?, radius? })"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.sharpen: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.sharpen: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    if (radius < 0 || radius > 100) {
        throwTypeError(globalObject, scope, "parabun:image.sharpen: radius must be in [0, 100]"_s);
        return {};
    }
    if (!std::isfinite(amount) || amount < -10.0f || amount > 10.0f) {
        throwTypeError(globalObject, scope, "parabun:image.sharpen: amount must be a finite number in [-10, 10]"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue imgArg = callFrame->argument(0);
    if (!imgArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.edgeDetect: expected (img)"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.edgeDetect: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.edgeDetect: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue optsArg = callFrame->argument(1);
    if (!imgArg.isObject() || !optsArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.rotate: expected (img, { degrees })"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    auto* optsObj = asObject(optsArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.rotate: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.rotate: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    RETURN_IF_EXCEPTION(scope, {});
    if (!degVal.isNumber()) {
        throwTypeError(globalObject, scope, "parabun:image.rotate: opts.degrees is required (number)"_s);
        return {};
    }
    const int32_t degrees = degVal.toInt32(globalObject);
    if (degrees != 90 && degrees != 180 && degrees != 270) {
        throwTypeError(globalObject, scope, "parabun:image.rotate: degrees must be 90, 180, or 270"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue optsArg = callFrame->argument(1);
    if (!imgArg.isObject() || !optsArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.flip: expected (img, { axis })"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    auto* optsObj = asObject(optsArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.flip: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.flip: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    RETURN_IF_EXCEPTION(scope, {});
    if (!axisVal.isString()) {
        throwTypeError(globalObject, scope, "parabun:image.flip: opts.axis must be \"horizontal\" or \"vertical\""_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue optsArg = callFrame->argument(1);
    if (!imgArg.isObject() || !optsArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.crop: expected (img, { x, y, width, height })"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    auto* optsObj = asObject(optsArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.crop: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(sw) * sh * channels) {
        throwTypeError(globalObject, scope, "parabun:image.crop: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    if (!xVal.isNumber() || !yVal.isNumber() || !cwVal.isNumber() || !chVal.isNumber()) {
        throwTypeError(globalObject, scope, "parabun:image.crop: opts.x, .y, .width, .height are all required (numbers)"_s);
        return {};
    }
    ...
    if (xS < 0 || yS < 0) {
        throwTypeError(globalObject, scope, "parabun:image.crop: opts.x and opts.y must be >= 0"_s);
        return {};
    }
    if (cwS < 1 || chS < 1) {
        throwTypeError(globalObject, scope, "parabun:image.crop: opts.width and opts.height must be >= 1"_s);
        return {};
    }
    ...
    if (x + cw > sw || y + ch > sh) {
        throwTypeError(globalObject, scope,
            makeString("parabun:image.crop: crop rectangle ("_s,
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue imgArg = callFrame->argument(0);
    if (!imgArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.toGrayscale: expected (img)"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.toGrayscale: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.toGrayscale: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    if (!imgArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.hueShift: expected (img, degrees)"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    JSValue widthVal = imgObj->get(globalObject, JSC::Identifier::fromString(vm, "width"_s));
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.hueShift: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.hueShift: img.data length doesn't match width*height*channels"_s);
        return {};
    }

    if (!degArg.isNumber()) {
        throwTypeError(globalObject, scope, "parabun:image.hueShift: degrees must be a number"_s);
        return {};
    }
    double degrees = degArg.toNumber(globalObject);
    if (!std::isfinite(degrees)) {
        throwTypeError(globalObject, scope, "parabun:image.hueShift: degrees must be finite"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue optsArg = callFrame->argument(1);
    if (!imgArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.adjust: expected (img, { brightness?, contrast?, saturation? })"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    JSObject* optsObj = optsArg.isObject() ? asObject(optsArg) : nullptr;
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.adjust: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.adjust: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    if (!inRange(brightness) || !inRange(contrast) || !inRange(saturation)) {
        throwTypeError(globalObject, scope, "parabun:image.adjust: brightness / contrast / saturation must each be a finite number in [-1, 1]"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue imgArg = callFrame->argument(0);
    if (!imgArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.histogram: expected (img)"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.histogram: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.histogram: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    if (!baseArg.isObject() || !overlayArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.composite: expected (base, overlay, { x?, y? })"_s);
        return {};
    }
    ...
    if (!extract(baseObj, "parabun:image.composite: base"_s, basePtr, bw, bh, bChannels)) return {};
    const uint8_t* overlayPtr = nullptr;
    uint32_t ow = 0, oh = 0, oChannels = 0;
    if (!extract(overlayObj, "parabun:image.composite: overlay"_s, overlayPtr, ow, oh, oChannels)) return {};
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue imgArg = callFrame->argument(0);
    if (!imgArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.invert: expected (img)"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.invert: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.invert: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue optsArg = callFrame->argument(1);
    if (!imgArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.threshold: expected (img, { value? })"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    JSObject* optsObj = optsArg.isObject() ? asObject(optsArg) : nullptr;
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 1 && channels != 3 && channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.threshold: channels must be 1, 3, or 4"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.threshold: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    if (value < 0 || value > 255) {
        throwTypeError(globalObject, scope, "parabun:image.threshold: value must be in [0, 255]"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSValue optsArg = callFrame->argument(1);
    if (!imgArg.isObject() || !optsArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.boxBlur: expected (img, { radius })"_s);
        return {};
    }
    auto* imgObj = asObject(imgArg);
    auto* optsObj = asObject(optsArg);
    ...
    const uint32_t channels = channelsVal.toUInt32(globalObject);
    if (channels != 4) {
        throwTypeError(globalObject, scope, "parabun:image.boxBlur: only 4-channel RGBA inputs supported in v1"_s);
        return {};
    }
    if (srcView->length() != static_cast<size_t>(w) * h * channels) {
        throwTypeError(globalObject, scope, "parabun:image.boxBlur: img.data length doesn't match width*height*channels"_s);
        return {};
    }
    ...
    RETURN_IF_EXCEPTION(scope, {});
    if (!radiusVal.isNumber()) {
        throwTypeError(globalObject, scope, "parabun:image.boxBlur: opts.radius is required (number)"_s);
        return {};
    }
    const int radius = radiusVal.toInt32(globalObject);
    if (radius < 0 || radius > 1000) {
        throwTypeError(globalObject, scope, "parabun:image.boxBlur: radius must be in [0, 1000]"_s);
        return {};
    }
    ...
    (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    if (!inArg.isCell() || inArg.asCell()->type() != JSC::Uint8ArrayType) {
        throwTypeError(globalObject, scope, "parabun:image.pipeline: input must be a Uint8Array"_s);
        return {};
    }
    if (!opsArg.isObject()) {
        throwTypeError(globalObject, scope, "parabun:image.pipeline: ops must be an array"_s);
        return {};
    }
    if (!outArg.isObject()) {
    ...
    if (!fmtIn) {
        throwTypeError(globalObject, scope, "parabun:image.pipeline: input format not recognized"_s);
        return {};
    }
    PipelineState state;
    state.useA = true;
    ...
    if (!ok) {
        throwTypeError(globalObject, scope, makeString("parabun:image.pipeline: decode: "_s, String::fromUTF8(errMsg)));
        return {};
    }
    ...
    if (!lengthVal.isNumber()) {
        throwTypeError(globalObject, scope, "parabun:image.pipeline: ops must have .length"_s);
        return {};
    }
    ...
    for (uint32_t i = 0; i < numOps; i++) {
        ...
        RETURN_IF_EXCEPTION(scope, {});
        if (!opVal.isObject()) {
            throwTypeError(globalObject, scope, makeString("parabun:image.pipeline: ops["_s, String::number(i), "] must be an object"_s));
            return {};
        }
        if (!applyPipelineOp(globalObject, scope, state, asObject(opVal), errMsg, sizeof(errMsg))) {
            throwTypeError(globalObject, scope, makeString("parabun:image.pipeline: "_s, String::fromUTF8(errMsg)));
            return {};
        }
    }
    ...
    RETURN_IF_EXCEPTION(scope, {});
    if (!formatVal.isString()) {
        throwTypeError(globalObject, scope, "parabun:image.pipeline: out.format is required"_s);
        return {};
    }
    ...
    if (std::strcmp(outFormat, "jpeg") == 0) {
        ...
        throwTypeError(globalObject, scope, makeString("parabun:image.pipeline: unknown out.format "_s, formatVal.toWTFString(globalObject)));
        return {};
    }
    if (!encOk) {
        throwTypeError(globalObject, scope, makeString("parabun:image.pipeline: encode: "_s, String::fromUTF8(errMsg)));
        return {};
    }
