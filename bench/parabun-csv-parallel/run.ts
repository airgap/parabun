// Sweep @lyku/para-csv parse times across a few input sizes, comparing serial
...
console.log(`@lyku/para-csv parse — sweep across ${sizes.join(", ")} MB, best-of-${RUNS} per cell\n`);
console.log(
  [
    "size".padEnd(7),
    "rows".padEnd(11),
