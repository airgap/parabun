...
var root = $.from_html(`<div><p class="svelte-17ay6rc">Slider</p> <span class="svelte-17ay6rc">Track</span></div> <!>`, 1);
...

	{
		var consequent = ($$anchor) => {
...

			{
				...
				$.css_props(node_1, () => ({ '--rail-color': railColor1(), '--track-color': trackColor1() }));
