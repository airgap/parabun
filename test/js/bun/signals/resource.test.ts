...
// @lyku/para-signals.resource — explicit-lifecycle reactive primitive.
...
describe("@lyku/para-signals.resource", () => {
  test("setup exports become handle properties; handle adds lifecycle", async () => {
    const sigs = (await import("@lyku/para-signals")).default;
...
describe("@lyku/para-signals.fromAsyncIter", () => {
...
describe("@lyku/para-signals.fromStream", () => {
...
describe("@lyku/para-signals.fromEventTarget", () => {
...
describe("@lyku/para-signals.throttled / debounced", () => {
