...
pub const HardcodedModule = enum {
    ...
    pub const map = bun.ComptimeStringMap(HardcodedModule, [_]struct { []const u8, HardcodedModule }{
        ...
        .{ "bun:arrow", .@"bun:arrow" },
        .{ "bun:audio", .@"bun:audio" },
        .{ "bun:camera", .@"bun:camera" },
        .{ "bun:csv", .@"bun:csv" },
        .{ "bun:assistant", .@"bun:assistant" },
        .{ "bun:gpio", .@"bun:gpio" },
        .{ "bun:gpu", .@"bun:gpu" },
        .{ "bun:i2c", .@"bun:i2c" },
        .{ "bun:image", .@"bun:image" },
    ...
    pub const Alias = struct {
        ...
        const bun_extra_alias_kvs = [_]struct { string, Alias }{
            ...
            .{ "bun:arena", .{ .path = "bun:arena" } },
            .{ "bun:arrow", .{ .path = "bun:arrow" } },
            .{ "bun:assistant", .{ .path = "bun:assistant" } },
            .{ "bun:audio", .{ .path = "bun:audio" } },
            .{ "bun:camera", .{ .path = "bun:camera" } },
            .{ "bun:csv", .{ .path = "bun:csv" } },
            .{ "bun:gpio", .{ .path = "bun:gpio" } },
            .{ "bun:gpu", .{ .path = "bun:gpu" } },
            .{ "bun:i2c", .{ .path = "bun:i2c" } },
            .{ "bun:image", .{ .path = "bun:image" } },
            .{ "bun:llm", .{ .path = "bun:llm" } },
            .{ "bun:mcp", .{ .path = "bun:mcp" } },
            ...
            .{ "bun:spi", .{ .path = "bun:spi" } },
            .{ "bun:video", .{ .path = "bun:video" } },
            .{ "bun:vision", .{ .path = "bun:vision" } },
