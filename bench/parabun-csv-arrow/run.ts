...
//
// Generates a 100k-row CSV in memory, parses it via bun:csv's streaming
// parser, converts to a columnar Arrow RecordBatch via arrow.fromRows,
// then runs a few filters + aggregations. Demonstrates that bun:csv and
// bun:arrow compose at the call site without either module knowing about
