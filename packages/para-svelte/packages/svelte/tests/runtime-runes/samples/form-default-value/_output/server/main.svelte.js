...
export default function Main($$renderer) {
	...
	$$renderer.push(`<form><p>Input/Textarea value</p> <div class="test-1"><input${$.attr('value', value1)}/> <input${$.attr('value', value2)}/> <input${$.attr('value', value3)}/> <input${$.attr('value', value4)}/> <textarea>`);
	...
	$$renderer.push(`</textarea></div> <div class="test-2"><input${$.attr('value', value9)}/> <input${$.attr('value', value10)}/> <input${$.attr('value', value11)}/> <input${$.attr('value', value12)}/> <textarea>`);
	...
	$$renderer.push(`</textarea></div> <div class="test-3"><input${$.attr('value', value17)}/> <input${$.attr('value', value18)}/> <input${$.attr('value', value19)}/> <input${$.attr('value', value20)}/> <textarea>`);
	...
	$$renderer.push(`</textarea></div> <p>Input checked</p> <div class="test-4"><input type="checkbox"${$.attr('checked', checked1, true)}/> <input type="checkbox"${$.attr('checked', checked2, true)}/> <input type="checkbox"${$.attr('checked', checked3, true)}/> <input type="checkbox"${$.attr('checked', checked4, true)}/></div> <div class="test-5"><input type="checkbox"${$.attr('checked', checked5, true)}/> <input type="checkbox"${$.attr('checked', checked6, true)}/> <input type="checkbox"${$.attr('checked', checked7, true)}/> <input type="checkbox"${$.attr('checked', checked8, true)}/></div> <div class="test-6"><input type="checkbox"${$.attr('checked', checked9, true)}/> <input type="checkbox"${$.attr('checked', checked10, true)}/> <input type="checkbox"${$.attr('checked', checked11, true)}/> <input type="checkbox"${$.attr('checked', checked12, true)}/></div> <div class="test-7"><input type="checkbox"${$.attr('checked', checked13, true)}/> <input type="checkbox"${$.attr('checked', checked14, true)}/></div> <p>Select (single)</p> `);
