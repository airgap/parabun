// 8192 × 8192 Sobel edge detection: single-threaded vs tiled pmap+SAB.
// Output image hash (FNV-1a over result bytes) must match across
// variants — same algorithm, bit-identical output.
//
