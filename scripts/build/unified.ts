...
const noUnify: readonly string[] = [
  ...
  "src/jsc/bindings/parabun_audio_codecs.cpp",
  "src/jsc/bindings/parabun_audio_io.cpp",
  "src/jsc/bindings/parabun_camera.cpp",
  "src/jsc/bindings/parabun_gpio.cpp",
  "src/jsc/bindings/parabun_i2c.cpp",
  "src/jsc/bindings/parabun_image_codecs.cpp",
  "src/jsc/bindings/parabun_simd_kernels.cpp",
  "src/jsc/bindings/parabun_spi.cpp",
];
