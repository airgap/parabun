// Parabun: native I2C bindings for `bun:i2c` (LYK-771 / PLAN-bun-hal).
//
...
//
// On non-Linux every entry point throws "bun:i2c not yet implemented on
// this platform".
...
#if !defined(__linux__)
    throwTypeError(globalObject, scope, "bun:i2c not yet implemented on this platform"_s);
    return {};
#else
