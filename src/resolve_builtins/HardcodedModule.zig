...
pub const HardcodedModule = enum {
    ...
    pub const map = bun.ComptimeStringMap(HardcodedModule, [_]struct { []const u8, HardcodedModule }{
        ...
        // Para libraries — canonical @lyku/para-* names. Each registers a
        // builtin that maps to the bundled JS impl from src/js/bun/<name>.ts.
        .{ "@lyku/para-arena", .@"@lyku/para-arena" },
        .{ "@lyku/para-arrow", .@"@lyku/para-arrow" },
        .{ "@lyku/para-lifecycle", .@"@lyku/para-lifecycle" },
        .{ "@lyku/para-mcp", .@"@lyku/para-mcp" },
        .{ "@lyku/para-parallel", .@"@lyku/para-parallel" },
        .{ "@lyku/para-pipeline", .@"@lyku/para-pipeline" },
        .{ "@lyku/para-rtp", .@"@lyku/para-rtp" },
        .{ "@lyku/para-signals", .@"@lyku/para-signals" },
        .{ "@lyku/para-simd", .@"@lyku/para-simd" },
        // LYK-805 deprecation aliases: legacy `para:*` import strings
        // route to their `@lyku/para-*` equivalents for one major release.
        .{ "para:arena", .@"@lyku/para-arena" },
        .{ "para:arrow", .@"@lyku/para-arrow" },
        .{ "para:lifecycle", .@"@lyku/para-lifecycle" },
        .{ "para:mcp", .@"@lyku/para-mcp" },
        .{ "para:parallel", .@"@lyku/para-parallel" },
        .{ "para:pipeline", .@"@lyku/para-pipeline" },
        .{ "para:rtp", .@"@lyku/para-rtp" },
        .{ "para:signals", .@"@lyku/para-signals" },
        .{ "para:simd", .@"@lyku/para-simd" },
        ...
        // the runtime-native name; @lyku/para-csv is the npm-side name; both
    ...
    pub const Alias = struct {
        ...
        const bun_extra_alias_kvs = [_]struct { string, Alias }{
            ...
            // Para libraries — canonical @lyku/para-* aliases.
            .{ "@lyku/para-arena", .{ .path = "@lyku/para-arena" } },
            .{ "@lyku/para-arrow", .{ .path = "@lyku/para-arrow" } },
            .{ "@lyku/para-lifecycle", .{ .path = "@lyku/para-lifecycle" } },
            .{ "@lyku/para-mcp", .{ .path = "@lyku/para-mcp" } },
            .{ "@lyku/para-parallel", .{ .path = "@lyku/para-parallel" } },
            .{ "@lyku/para-pipeline", .{ .path = "@lyku/para-pipeline" } },
            .{ "@lyku/para-rtp", .{ .path = "@lyku/para-rtp" } },
            .{ "@lyku/para-signals", .{ .path = "@lyku/para-signals" } },
            .{ "@lyku/para-simd", .{ .path = "@lyku/para-simd" } },
            // LYK-805 deprecation aliases — para:* import strings
            // resolve to the @lyku/para-* builtin during the deprecation
            // window. Drop one major release after consumers migrate.
            .{ "para:arena", .{ .path = "@lyku/para-arena" } },
            .{ "para:arrow", .{ .path = "@lyku/para-arrow" } },
            .{ "para:lifecycle", .{ .path = "@lyku/para-lifecycle" } },
            .{ "para:mcp", .{ .path = "@lyku/para-mcp" } },
            .{ "para:parallel", .{ .path = "@lyku/para-parallel" } },
            .{ "para:pipeline", .{ .path = "@lyku/para-pipeline" } },
            .{ "para:rtp", .{ .path = "@lyku/para-rtp" } },
            .{ "para:signals", .{ .path = "@lyku/para-signals" } },
            .{ "para:simd", .{ .path = "@lyku/para-simd" } },
            ...
            // LYK-804: csv name aliases — @lyku/para-csv (npm-side) and
