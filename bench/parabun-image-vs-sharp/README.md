...
## Kernel-only — parabun:image clearly surpasses Sharp
...
## When parabun:image is the right pick
...
- **Always** for `bun build --compile` deploys — Sharp pulls ~30 MB
  ...
  at install time; parabun:image is statically linked into the runtime.
