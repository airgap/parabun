...
describe("parabun:assistant chunkText (LYK-738)", () => {
  test("splits on blank-line boundaries, preserves offsets", async () => {
    const a = (await import("parabun:assistant")).default;
...
describe("parabun:assistant KnowledgeStore (LYK-738)", () => {
...
describe("parabun:assistant `knowledge` option (LYK-738)", () => {
