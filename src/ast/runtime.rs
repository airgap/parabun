...
pub struct Imports {
    ...
    // Parabun runtime helpers (appended at the end so existing indices are
    // unchanged). Exported from src/runtime.js.
    pub __parabunMemo: Option<Ref>,
    ...
    pub __paraTsSchema: Option<Ref>,
}

impl Imports {
    pub const ALL: [&'static [u8]; 36] = [
        b"__name",
        b"__require",
        b"__export",
        b"__reExport",
    ...
    pub const ALL_SORTED_INDEX: [usize; 36] = [
        13, // __name
        33, // __require
        5,  // __export
        32, // __reExport
        ...
        22, // __parabunMemo
        23, // __parabunRange
        24, // __parabunRangeInclusive
        15, // __paraFromSchema
        14, // __paraDec
        20, // __parabunAsyncDefer0
        21, // __parabunDefer0
        16, // __paraSchemaDecl
    ...
    fn field_mut(&mut self, i: usize) -> Option<&mut Option<Ref>> {
        match i {
            ...
            25 => Some(&mut self.__parabunMemo),
            ...
            35 => Some(&mut self.__paraTsSchema),
            _ => None,
        }
    }
