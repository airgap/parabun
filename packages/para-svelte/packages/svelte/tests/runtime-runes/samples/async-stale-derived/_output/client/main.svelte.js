		...
		$.boundary(node, { pending }, ($$anchor) => {
...

			{
				var consequent = ($$anchor) => {
					...
					$.reset(p_1);
					$.template_effect(($0) => $.set_text(text, `delayed: ${$0 ?? ''}`), void 0, [() => push()]);
					$.append($$anchor, p_1);
				};
				...
				var alternate = ($$anchor) => {
					...
					$.reset(p_2);
					$.template_effect(($0) => $.set_text(text_1, $0), void 0, [() => $.get(count)]);
					$.append($$anchor, p_2);
				};

				$.if(node_1, ($$render) => {
					if ($.get(count) % 2) $$render(consequent); else $$render(alternate, -1);
				});
			}
