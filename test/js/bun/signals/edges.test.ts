...
// @lyku/para-signals.when(src, fn) — fires fn once per false→true transition of
...
describe("@lyku/para-signals.when (rising-edge form)", () => {
...
describe("@lyku/para-signals.when (falling-edge via negated predicate)", () => {
