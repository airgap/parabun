/**
 * libwebp — Google's reference WebP codec. Backs both upstream
 * `Bun.Image` and Para's `parabun:image` (via WebPDecodeRGBA /
 * WebPEncode*) plus the SharpYUV RGB→YUV converter the encoder
 * prefers.
 *
