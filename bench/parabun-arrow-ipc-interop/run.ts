// Wire-compat interop test for @lyku/para-arrow IPC against apache-arrow's
...
import parabunArrow from "@lyku/para-arrow";
import {
  tableFromIPC,
  tableToIPC,
  Table as AATable,
...
console.log("=== @lyku/para-arrow ↔ apache-arrow IPC interop ===\n");
...
console.log(
  `\n${allPass ? "=== all directions ok — @lyku/para-arrow IPC is wire-compatible with apache-arrow ===" : "=== INTEROP FAILURES ==="}`,
);
