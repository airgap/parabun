...
describe("@lyku/para-parallel.psort — correctness", () => {
  test("empty + single-element arrays return a copy unchanged", async () => {
    const parallel = (await import("@lyku/para-parallel")).default;
...
describe("@lyku/para-parallel.psort — sample-sort strategy", () => {
...
describe("@lyku/para-parallel.psort — typed-array radix path", () => {
...
describe("@lyku/para-parallel.psort — fallback decisions", () => {
