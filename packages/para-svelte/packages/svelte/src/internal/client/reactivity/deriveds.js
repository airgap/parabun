...
import { async_effect, destroy_effect, destroy_effect_children, effect_tracking, teardown } from "./effects.js";
import { eager_effects, internal_set, mirror_to_para, set_eager_effects, source } from "./sources.js";
  ...
  if (!derived.equals(value)) {
    ...
    if (!current_batch?.is_fork || derived.deps === null) {
      if (current_batch !== null) {
        ...
        derived.v = value;
        // Para Svelte bridge: no-batch recompute path. Batch.capture handles
        // the batched recompute case; this branch runs when no batch is active
        // (e.g. derived read outside any reactive update). See PARA-FORK.md.
        mirror_to_para(derived, value);
      }
