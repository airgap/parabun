...
pub const HardcodedModule = enum {
    ...
    pub const map = bun.ComptimeStringMap(HardcodedModule, [_]struct { []const u8, HardcodedModule }{
        ...
        .{ "para:camera", .@"para:camera" },
        .{ "para:csv", .@"para:csv" },
        .{ "para:assistant", .@"para:assistant" },
        .{ "para:gpio", .@"para:gpio" },
        .{ "para:gpu", .@"para:gpu" },
        .{ "para:i2c", .@"para:i2c" },
        ...
        .{ "para:simd", .@"para:simd" },
        .{ "para:speech", .@"para:speech" },
        .{ "para:spi", .@"para:spi" },
        .{ "para:video", .@"para:video" },
        .{ "para:vision", .@"para:vision" },
        .{ "bun:wrap", .@"bun:wrap" },
    ...
    pub const Alias = struct {
        ...
        const bun_extra_alias_kvs = [_]struct { string, Alias }{
            ...
            .{ "para:assistant", .{ .path = "para:assistant" } },
            .{ "para:audio", .{ .path = "para:audio" } },
            .{ "para:camera", .{ .path = "para:camera" } },
            .{ "para:csv", .{ .path = "para:csv" } },
            .{ "para:gpio", .{ .path = "para:gpio" } },
            .{ "para:gpu", .{ .path = "para:gpu" } },
            .{ "para:i2c", .{ .path = "para:i2c" } },
            .{ "para:image", .{ .path = "para:image" } },
            .{ "para:llm", .{ .path = "para:llm" } },
            ...
            .{ "para:speech", .{ .path = "para:speech" } },
            .{ "para:spi", .{ .path = "para:spi" } },
            .{ "para:video", .{ .path = "para:video" } },
            .{ "para:vision", .{ .path = "para:vision" } },
